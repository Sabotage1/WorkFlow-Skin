...
- [WorkFlow Skin v0.3.11](https://github.com/Sabotage1/WorkFlow-Skin/releases/tag/v0.3.11)
- Release asset: `workflow-skin.zip`
- Community API: `https://workflow-skin-community.sabotage1.workers.dev`

Version 0.3.11 confirms machine sleep and opens Review immediately, including shots without a scale, while retaining wake recovery for Decaid 0.8.5. See the
