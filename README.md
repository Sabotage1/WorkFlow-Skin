...
- [WorkFlow Skin v0.3.10](https://github.com/Sabotage1/WorkFlow-Skin/releases/tag/v0.3.10)
- Release asset: `workflow-skin.zip`
- Community API: `https://workflow-skin-community.sabotage1.workers.dev`

Version 0.3.10 includes wake recovery fixes for Decaid 0.8.5. See the
